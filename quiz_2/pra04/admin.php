...
<body>
	<div id="all">
    	<div id="title">
        <?=date("m 月 d 號 l")?> | 今日瀏覽: <?=$_SESSION['total']?> | 累積瀏覽: <?php q("select sum(`total`) as `total` from `total`")[0]['total']?>       </div>
		<a href="index.php"style='float:right'>回首頁</a>
        <div id="title2">
        	<a href="index.php" title="健康促進網-回首頁"><img src="./icon/020B01.jpg" alt=""></a>
        </div>
        <div id="mm">

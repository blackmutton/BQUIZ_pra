...
<script>
    $(".tag").on('click', function() {
        ...
        // 將索引值對應的`.article`元素添加`active`類，使其顯示出來
        // .eq()用於選擇匹配元素集合中的一個特定元素，$(selector).eq(index)
        // $(this).index('.tag')：獲取當前被點擊的.tag元素在所有.tag元素中的索引值
        // $(".article").eq(...)：選擇匹配.article元素集合中索引值與當前被點擊的.tag元素索引值相同的元素。
